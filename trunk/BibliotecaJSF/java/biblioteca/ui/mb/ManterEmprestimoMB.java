...
public class ManterEmprestimoMB implements Serializable {
		...
		else 
		{
			...
			{	//esqueleto de emprestimo NOVO
				...
				if(livro==null)// livro do exemplar nao existe
				{
					...
					mensagemEmprestimo = "Item informado não existe no cadastro"; //colocar mensagem do livroBC no futuro caso livro n�o exista
					editandoEmprestimo = false;
					consultandoEmprestimo = true;
				}
				else //livro existe
			...
			{	
				//var emprestimos cont�m os dados do emprestimo retornados da camada de persistencia
	...
	/*
	 * pesquisa emprestimos existentes para os crit�rios do Form
